...
var translations = map[string]map[string]string{
	"en": {
		...
		"deploy.base_preset":        "Base preset",
		"deploy.base_preset_hint":   "Passwords, NTP, etc. applied to every node (defaults if none).",
		"deploy.base_defaults":      "— built-in defaults —",
		"deploy.nodes":              "Nodes",
		"deploy.dns":                "DNS (comma-separated)",
	...
	"fr": {
		...
		"deploy.base_preset":        "Preset de base",
		"deploy.base_preset_hint":   "Mots de passe, NTP, etc. appliqués à chaque nœud (defaults si aucun).",
		"deploy.base_defaults":      "— defaults intégrés —",
		"deploy.nodes":              "Nœuds",
		"deploy.dns":                "DNS (séparés par des virgules)",
		"deploy.destination":        "Destination (Proxmox VE)",
