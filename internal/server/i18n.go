...
var translations = map[string]map[string]string{
	"en": {
		...
		"deploy.sizing":              "VM sizing",
		"deploy.vm_cpus":             "vCPUs",
		"deploy.vm_memory":           "Memory (MiB)",
		"deploy.vm_bridge":           "Network bridge",
		"deploy.grub_timer":          "GRUB timer (s)",
		"deploy.grub_timer_hint":     "Per-node wait for the GRUB menu before typing the boot command. Overrides the global boot wait; empty = use it.",
		...
		"deploy.wire_advanced":       "Advanced — show REST API sequence",
	...
	"fr": {
		...
		"deploy.sizing":              "Dimensionnement VM",
		"deploy.vm_cpus":             "vCPU",
		"deploy.vm_memory":           "Mémoire (Mio)",
		"deploy.vm_bridge":           "Bridge réseau",
		"deploy.grub_timer":          "Timer GRUB (s)",
		"deploy.grub_timer_hint":     "Délai par nœud d'attente du menu GRUB avant de taper la commande de boot. Remplace le délai global ; vide = l'utiliser.",
		...
		"deploy.wire_advanced":       "Avancé — afficher la séquence REST API",
